...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <h4>New Schedule Summary by Day</h4>
            <table id="" class="new-day-summary summary-table table table-condensed">
                <tr class="info day-header">
                    <td align="center" rowspan="2" class="day-label">Sun<br/>6/17</td>
                    <td align="right"><strong>Sales</strong></td>
                    <td align="right"><strong>EmpTarget</strong></td>
