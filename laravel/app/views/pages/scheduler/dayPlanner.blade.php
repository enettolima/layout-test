        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="message-confirm" type="button" data-event-id="" data-dismiss="modal" class="btn">Ok</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="block-remove-modal-confirm" type="button" data-event-id="" class="btn btn-danger">Delete Block</button>
                    <button id="block-set-sellable-confirm" type="button" sellable-event-id="" class="btn btn-default" data-dismiss="modal">Set Non-Sellable</button>
                </div>
            </div>
        </div>
    </div>
