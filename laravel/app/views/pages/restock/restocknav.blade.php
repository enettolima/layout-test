<div class="btn-group btn-group-justified" role="group">
    ...
    <a href="/restock/carts" class="btn btn-default <?php echo Request::is('restock/carts*') ?  'btn-primary' : '' ?>" role="button">Cart <span class="badge" id="cart-badge-count">{{$items_count}}</span></a>
