        ...
        <div class="wrapper wrapper-content animated fadeInUp">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <dl class="dl-horizontal">
                                ...
                                <dt>P.O. Number:</dt> <dd>  06072015</dd>
                                <dt>Vendor Code:</dt> <dd>935</dd>
                                <dt>Vendor:</dt> <dd><a href="#" class="text-navy"> INDIA - 360 CLOTHING</a> </dd>
                                <dt>Total:</dt> <dd><strong>$14350.00</strong></dd>
                                <dt>Shipping Address:</dt> <dd>4051 Freeport Parkway, STE 400, <br>Grapevine, TX, 76051<br>972-248-0228</dd>
                                <dt>Billing Address:</dt> <dd>4051 Freeport Parkway, STE 400, <br>Grapevine, TX, 76051<br>972-248-0228</dd>
                                <dt>Order Date:</dt> <dd>09/11/2015 12:23</dd>
                            </dl>
                        </div>
                        <div class="col-lg-7" id="cluster_info">
                            <dl class="dl-horizontal" >
                              <dt>B/L Number & Copy:</dt> <dd></dd>
                              <dt>Importer of Record:</dt> <dd> 20-4010374 </dd>
                              <dt>Consignee Number:</dt> <dd> 20-4010374 </dd>
                              <dt>Origin Port:</dt> <dd> India </dd>
                    ...
                    <form class="modal multi-step inmodal fade" id="demo-modal">
                      <div class="modal-dialog modal-lg">
                          <div class="modal-content">

                              <div class="modal-header">
                                  <h4 class="modal-title step-1" data-step="1">Add Product to Order</h4>
                                  <h4 class="modal-title step-2" data-step="2">Add Quantity</h4>
                              </div>
                              ...
                              <div class="modal-body step step-2">
                                <h4>Dress-Olive MAXI-S</h4>
                                <input type="text" placeholder="Quantity" class="form-control">
                              </div>
                              <div class="modal-footer">
                                  <button type="button" class="btn btn-default" data-dismiss="modal">Add Now</button>
                              </div>
                          </div>
                      </div>
                  </form>
                  ...
                  sendEvent = function() {
                    ...
                    <div class="modal inmodal fade" id="participantsModal" tabindex="-1" role="dialog"  aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                    <h4 class="modal-title">Add participants</h4>
                                    <small class="font-bold">Participants will receive notifications for every change made on the order.</small>
                                </div>
                    ...
                    <div class="modal inmodal fade" id="removeProduct" tabindex="-1" role="dialog"  aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                ...
                                <div class="modal-body">
                                    <small class="font-bold">Are you sure you want to remove the product Dress-Olive MAXI-S from the Order?</small>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-white" data-dismiss="modal">Cancel</button>
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Yes, Remove Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal inmodal fade" id="editQuantity" tabindex="-1" role="dialog"  aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <h4>Dress-Olive MAXI-S</h4>
                                  <input type="text" placeholder="Quantity" class="form-control" value="205">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-white" data-dismiss="modal">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-t-sm">
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="tab-1">
                            ...
                            <a href="#" class="btn btn-white btn-xs" data-toggle="modal"  data-target="#demo-modal"><i class="fa fa-plus"></i> Add Product</a><br><br>
