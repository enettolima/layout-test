                   ...
                   <!--  <small>You have 42 messages and 6 notifications.</small> -->
                    <ul class="list-group clear-list m-t">
                        <li class="list-group-item fist-item">
                            ...
                            <span class="label label-success">#24543</span>
                        </li>
                        <li class="list-group-item">
                            <span class="pull-right">
                                $62,345.00
                            </span>
                            <span class="label label-default">#67567</span>
                        </li>
                        <li class="list-group-item">
                            <span class="pull-right">
                                $23,585.00
                            </span>
                            <span class="label label-primary label-default">#17655</span>
                        </li>
                        <li class="list-group-item">
                            <span class="pull-right">
                                $33,343.00
                            </span>
                            <span class="label label-default">#98754</span>
                        </li>
                        <li class="list-group-item">
                            <span class="pull-right">
                                $20,005.00
                            </span>
                            <span class="label label-primary label-default">#29375</span>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-9">
                                ...
                                <div class="ibox-content">
                                    <div>
                                        <div class="pull-right text-right">
                                            <h4 class="font-bold">$ 20,054.43</h4>
                                        </div>
                                        <h4>#21635
                                            <br/>
                                            <small class="m-r">4 Products</small>
                                            <small class="m-r">2,500 Items</small>
                                        </h4>
                                    </div>
                                </div>
                                <div class="ibox-content">
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div>
                                        ...
                                        <div class="progress progress-mini">
                                            <div style="width: 73%;" class="progress-bar progress-bar-danger"></div>
                                        </div>
                                    </div>
                                    <div class="row  m-t-sm">
                                        <div class="col-sm-4">
                                        ...
                                        <span class="label label-primary pull-right label-danger">OVERDUE</span>
                                    </div>
                                </div>
                            </div>
                        </div>
